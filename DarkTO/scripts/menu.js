    ...
    try{
        ...
        //menu creating
            if(a){
                ...
                const tabImagesP = createP(lan.tabImages);
                const tabImagesCheck = checkBox();

                tabImagesCheck.checked = data.themeSettings.tabImages;

                tabImagesCheck.addEventListener('click', () => {
                    data.themeSettings.tabImages = !(data.themeSettings.tabImages);
                    setTheme();
                    dataSave();
                })
                ...
                const autoResetP = createP(lan.autoResetTimer);
