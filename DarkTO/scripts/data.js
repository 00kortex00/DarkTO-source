...
const lan = {
    ...
    timerPosList: (lang() == 'ru') ? ['Скрыт', 'Справа посередине', 'Справа снизу', 'Посередине снизу', 'Слева снизу', 'Слева посередине', 'Слева сверху', 'Сверху посередине', 'Справа сверху'] : ['Hide', 'Right middle', 'Right bottom', 'Middle bottom', 'Left bottom', 'Left middle', 'Left top', 'Middle top', 'Right top'],
    ...
    autoResetTimer: (lang() == 'ru') ? "Автоматический перезапуск таймера:" : "Auto reset timer:",
    tabImages: (lang() == 'ru') ? "Отоброжать пушки и корпуса в табе" : "Show turrets and hulls in tab list",
}
